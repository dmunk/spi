...
?>
      <h2><a href="/product_catalog/" title="Return to Spirited Packaging Product Catalog" style="font-weight: bold;">Product Catalog</a> > Standard Burgundy wine bottle, Dead Leaf Green &#8212; SPI-2006DLG</h2>
      <hr />
      <div style="float: left;">
      <a href="/images/products/wine_bottles/standard-burgundy-dead-leaf-green-spi-2006dlg-large.jpg" title="Standard Burgundy wine bottle, Dead Leaf Green - SPI-2006DLG -- Click to enlarge" target="_blank"><img src="/images/products/wine_bottles/standard-burgundy-dead-leaf-green-spi-2006dlg.jpg" alt="Standard Burgundy wine bottle, Dead Leaf Green - SPI-2006DLG" style="margin-bottom: 10px;" /></a>
      </div>
      <div style="float: right;">
      <a href="/images/products/wine_bottles/data_sheets/standard-burgundy-spi-2006_front.pdf" title="Data sheet for Standard Burgundy wine bottle, Dead Leaf Green - SPI-2006DLG -- Click to enlarge" target="_blank"><img src="/images/products/wine_bottles/data_sheets/standard-burgundy-spi-2006_front.gif" alt="Data sheet for Standard Burgundy wine bottle, Dead Leaf Green - SPI-2006DLG" style="margin-bottom: 10px;" /></a>
      </div>
      <hr />
      <h3>Product Specifications:</h3>
      <ul class="infoList">
        <li><strong>Part #:</strong><span>SPI-2006DLG</span></li>
...
if( empty( $_POST['emailSubject'] ) )
  $_POST['emailSubject'] = 'RE: SPI-2006DLG';
