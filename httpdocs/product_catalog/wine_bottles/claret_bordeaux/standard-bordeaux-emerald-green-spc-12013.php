...
?>
      <h2><a href="/product_catalog/" title="Return to Spirited Packaging Product Catalog" style="font-weight: bold;">Product Catalog</a> > Standard Bordeaux wine bottle, Emerald Green &#8212; SPC-12013</h2>
      <hr />
      <div style="float: left;">
      <a href="/images/products/wine_bottles/standard-bordeaux-emerald-green-spc-12013-large.jpg" title="Standard Bordeaux wine bottle, Emerald Green - SPC-12013 -- Click to enlarge" target="_blank"><img src="/images/products/wine_bottles/standard-bordeaux-emerald-green-spc-12013.jpg" alt="Standard Bordeaux wine bottle, Emerald Green - SPC-12013" style="margin-bottom: 10px;" /></a>
      </div>
      <hr />
      <h3>Product Specifications:</h3>
      <ul class="infoList">
        <li><strong>Part #:</strong><span>SPC-12013</span></li>
        <li><strong>Capacity:</strong><span>750ml</span></li>
        <li><strong>Weight:</strong><span>465g</span></li>
...
if( empty( $_POST['emailSubject'] ) )
  $_POST['emailSubject'] = 'RE: SPC-12013';
